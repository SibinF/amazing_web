...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="quote" id="quote" class="form-control" value="{{$model['quote'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="trip_sub_category_id" id="trip_sub_category_id" class="form-control" value="{{$model['trip_sub_category_id'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="no_of_day" id="no_of_day" class="form-control" value="{{$model['no_of_day'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="no_of_night" id="no_of_night" class="form-control" value="{{$model['no_of_night'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="travel_type_id" id="travel_type_id" class="form-control" value="{{$model['travel_type_id'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="depature_date" id="depature_date" class="form-control" value="{{$model['depature_date'] or ''}}" readonly="readonly">
            </div>
        </div>
