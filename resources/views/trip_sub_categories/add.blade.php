...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Trip_sub_category    </div>

    <div class="panel-body">
                
        <form action="{{ url('/trip_sub_categories'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="trip_category_id" id="trip_category_id" class="form-control" value="{{$model['trip_category_id'] or ''}}">
                </div>
            </div>
