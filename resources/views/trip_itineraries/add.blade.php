...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Trip_itinerary    </div>

    <div class="panel-body">
                
        <form action="{{ url('/trip_itineraries'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-6">
                    <input type="text" name="banner_image_four" id="banner_image_four" class="form-control" value="{{$model['banner_image_four'] or ''}}">
                </div>
            </div>
